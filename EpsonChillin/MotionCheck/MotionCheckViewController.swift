...
//        cameraVC.cameraViewTransform = CGAffineTransform(translationX: 0, y: 170).scaledBy(x: scale, y: scale)
//        
...
//        if isFrontCamera {
//            // 좌우 대칭하여 이미지를 저장
//            imageToSave = UIImage(cgImage: capturedImage.cgImage!, scale: capturedImage.scale, orientation: .upMirrored)
//        }
//        
